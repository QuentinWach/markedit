...
class MarkdownEditor:
    def __init__(self):
        ...
        self.web_widget.resize(600, 800)
        
        self.html_template = r"""
        <html>
        <head>
        ...
        # Create preview frame (now using QWebEngineView)
...
\\]
    ...
    def insert_html_content(self, html_content):
        ...
        self.web_widget.setHtml(full_html)
    ...
    def update_preview(self):
        ...
        if self.show_raw_html:
            ...
            self.web_widget.setHtml(f"<pre style='background-color: #f0f0f0; padding: 10px; font-family: monospace;'>{escaped_html}</pre>")
        else:
